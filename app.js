const WA_NUMBER = '34000000000';

// ─── BANNER ──────────────────────────────────────────────────────────────────
const DEFAULT_BANNER = {
  activo: true,
  texto: '💎 Nueva colección de pendientes — ¡Escríbeme!',
  color: 'terracota'
};
...
function buildWaLink(p) {
  const msg = encodeURIComponent(`Hola! Me interesan los pendientes: ${p.nombre} (${p.precio}€). ¿Están disponibles?`);
